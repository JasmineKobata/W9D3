...
/* harmony import */ var _util_api__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./util/api */ "./app/javascript/util/api.js");
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return (0,_util_api__WEBPACK_IMPORTED_MODULE_6__.followUser)(this.toggleButton.dataset.userId);
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 3;
                return (0,_util_api__WEBPACK_IMPORTED_MODULE_6__.unfollowUser)(this.toggleButton.dataset.userId);
...
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./util */ "./app/javascript/util/index.js");
...
var InfiniteTweets = /*#__PURE__*/function () {
  function InfiniteTweets(rootEl) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return _util__WEBPACK_IMPORTED_MODULE_6__.API.fetchTweets({
                  type: this.rootEl.dataset.type,
                  offset: this.ultag.children.length
                });
              ...
              case 4:
                ...
                res.forEach(function (obj) {
                  return _this.appendTweet(obj);
                }); // Remove fetch tweets button if you've run out of tweets to fetch

                if (res.length < 10
                /* REPLACE */
                ) {
                  noMoreTweets = document.createElement("p");
                  noMoreTweets.innerText = "No more tweets!"; // Your code here
                }
...
function followUser(id) {
  return customFetch("/users/".concat(id, "/follow"), {
    method: 'POST'
  });
}
...
function fetchTweets() {
  ...
  var queryParams = "".concat(new URLSearchParams(options));
  return customFetch("/tweets/?".concat(queryParams));
}
...
var infiniteTweetsSelector = ".infinite-tweets";
